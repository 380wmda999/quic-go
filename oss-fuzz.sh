...
(
# fuzz quic-go
compile_go_fuzzer github.com/380wmda999/quic-go/fuzzing/frames Fuzz frame_fuzzer
compile_go_fuzzer github.com/380wmda999/quic-go/fuzzing/header Fuzz header_fuzzer
compile_go_fuzzer github.com/380wmda999/quic-go/fuzzing/transportparameters Fuzz transportparameter_fuzzer
compile_go_fuzzer github.com/380wmda999/quic-go/fuzzing/tokens Fuzz token_fuzzer
compile_go_fuzzer github.com/380wmda999/quic-go/fuzzing/handshake Fuzz handshake_fuzzer
...
cd $GOPATH/src/github.com/380wmda999/quic-go/
