...
//
//	mockgen -typed -package quic -self_package github.com/380wmda999/quic-go -self_package github.com/380wmda999/quic-go -destination mock_packetconn_test.go net PacketConn
//
