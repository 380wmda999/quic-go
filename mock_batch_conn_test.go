...
//
//	mockgen -typed -package quic -self_package github.com/380wmda999/quic-go -source sys_conn_oob.go -destination mock_batch_conn_test.go -mock_names batchConn=MockBatchConn
//
