...
import (
	...
	"github.com/380wmda999/quic-go/logging"
)

//go:generate sh -c "go run go.uber.org/mock/mockgen -typed -build_flags=\"-tags=gomock\" -package internal -destination internal/tracer.go github.com/380wmda999/quic-go/internal/mocks/logging Tracer"
...
//go:generate sh -c "go run go.uber.org/mock/mockgen -typed -build_flags=\"-tags=gomock\" -package internal -destination internal/connection_tracer.go github.com/380wmda999/quic-go/internal/mocks/logging ConnectionTracer"
